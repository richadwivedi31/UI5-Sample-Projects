		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First project",
									"targetURL": "#sabbtpproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sabbtpproject1-display": {
								"semanticObject": "sabbtpproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sab.btp.project1",
									"url": sap.ui.require.toUrl("sab/btp/project1")
								}
							}
						}
					}
